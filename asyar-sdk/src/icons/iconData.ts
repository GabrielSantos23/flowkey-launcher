export const ICON_DATA: Record<string, string> = {
  ...
  `,
  // Full-color Google Translate brand mark — the hex fills are the logo's own
  // colors, deliberately not tokens. 998-grid artwork scaled into the 24 grid;
  // stroke="none" overrides the currentColor stroke the renderer wraps around
  // every icon.
  'google-translate': `
    <g transform="scale(0.024)" stroke="none">
      ...
      <path fill="#4352B8" d="M482.3 809.8 543.7 998.3 714.4 809.8z" />
