...
export type { IIslandService, IslandShowOptions } from './IIslandService';
...
export { IslandServiceProxy } from './IslandServiceProxy';
...
export type { IOpenerService, OpenPathOptions } from './IOpenerService';
export { OpenerServiceProxy } from './OpenerServiceProxy';
