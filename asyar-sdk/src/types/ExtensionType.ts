...
export interface ExtensionCommand {
   ...
   * does not mind which. Needs two or more names, none of them `required` products.
   */
  requireAnyOf?: string[];
  /**
  ...
  /**
   * Optional placeholder string displayed in the launcher's search bar
   * when this command's view is active. Only valid on `mode: "view"` commands.
   */
