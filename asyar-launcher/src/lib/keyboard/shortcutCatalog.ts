 ...
 * here. ⌘Q is intentionally omitted — Flowkey blocks it; users quit via the
 * "Quit Flowkey" command.
 */
...
export const LAUNCHER_SHORTCUTS: readonly ShortcutEntry[] = [
  ...
  { keys: ['Esc'], label: 'Clear the search, go back, then hide Flowkey', scope: 'global' },
  {
    keys: ['⌫'],
