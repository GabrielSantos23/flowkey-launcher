...
import { setupSearchEffects, createSearchHandlers } from './searchController';
import { setupSelectionEffects } from './selectionEffects';
...
export class LauncherController {
  ...
  get activeViewPlaceholderVal() {
    return this.state.activeViewPlaceholderVal;
  }
  ...
  async handleEnterKey() {
    ...
    if (selectedItem.action && typeof selectedItem.action === 'function') {
      ...
      try {
        ...
        if (navigated) {
          this.state.localSearchValue = searchStores.query;
