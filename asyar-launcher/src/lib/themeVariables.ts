/** All CSS custom property names that belong to the Flowkey design system. */
export const THEME_VAR_NAMES: readonly string[] = [
  ...
  // enough to read as text on an Flowkey surface is too light to carry white
...
/**
 * Reads the current computed values of all Flowkey design token CSS variables
