...
class ContextModeService {
  ...
  public activeContext: ActiveContext | null = null;
  public contextHint: ContextHint | null = null;
  public contextActivationId: string | null = null;
  public pinnedHintProviderId: string | null = null;
