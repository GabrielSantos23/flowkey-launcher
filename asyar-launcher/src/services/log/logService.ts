...
export class LogService implements ILogService {
  ...
  private tryLog(
    ...
    try {
      ...
      const result = tauriLogFn(message);
      // The plugin-log promise can reject outside a real webview (plain node
      // test env) — swallow it so it never becomes an unhandled rejection.
