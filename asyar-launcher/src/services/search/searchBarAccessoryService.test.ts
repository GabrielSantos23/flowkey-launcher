...
vi.mock('../extension/extensionIframeManager', () => ({
  extensionIframeManager: { sendFilterChangeToView: vi.fn() },
}));

import { invoke } from '@tauri-apps/api/core';
import { searchBarAccessoryService } from './searchBarAccessoryService';
import { extensionIframeManager } from '../extension/extensionIframeManager';
