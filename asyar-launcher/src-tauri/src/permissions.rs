...
fn is_public_call(call_type: &str) -> bool {
    matches!(
        ...
        // Ephemeral, extension-scoped feedback UI — toast / progress / island /
        ...
        // (Notification-like feedback — announce / sendBackground — stays gated.)
            ...
            | "asyar:api:island:show"
            | "asyar:api:island:dismiss"
        ...
        // `clipboard:stopMonitoring` toggles clipboard-history capture.
        // Preserved as public to keep current behavior.
...
mod tests {
    ...
    fn gate_decision_allows_scoped_feedback_and_action_exec() {
        // Ephemeral, extension-scoped feedback UI (toast/progress/island/confirm)
